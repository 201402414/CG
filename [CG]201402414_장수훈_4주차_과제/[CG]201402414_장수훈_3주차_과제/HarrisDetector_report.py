...
def HarrisDetector(src, gaus_filter_size = 3, gaus_sigma = 1, alpha = 0.04, threshold_rate = 0.01):
    ...
    """
    G_IxIx = GaussianFiltering(IxIx, fshape = (3,3), sigma=1)
    G_IyIy = GaussianFiltering(IyIy, fshape = (3,3), sigma=1)
    G_IxIy = GaussianFiltering(IxIy, fshape = (3,3), sigma=1)
    ...
    """
    har = G_IxIx * G_IyIy - np.square(G_IxIy) - 0.12*np.square(G_IxIx + G_IyIy)
